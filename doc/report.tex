...
Случай с произвольной взаимной ориентацией электрического и магнитного поля является суперпозицией рассмотренных выше простых случаев с коллинеарной и ортогональной взаимной ориентацией.

Для примера рассмотрим случай, когда электрическое поле направлено вдоль оси $OX$, а магнитное имеет равные проекции на оси $OX$ и $OZ$. Ожидаемый результат -- некое подобие циклоиды, движущейся по баллистической траектории, что и подтверждается моделированием (\autoref{fig:electromagnetic_4}).

\begin{figure}[h]%
\centering
	\includegraphics[width=0.8\textwidth]{electromagnetic_4}%
\caption[Движение в электромагнитном поле]{Движение в электромагнитном поле. Начальная скорость направлена по оси $OX$. Электрическое поле направлено по оси $OZ$, магнитное имеет равные проекции на оси $OX$ и $OY$}%
\label{fig:electromagnetic_4}%
\end{figure}
